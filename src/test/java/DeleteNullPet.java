...
public class DeleteNullPet {
    ...
    public void test() {
        ...
        //удаление несуществующего питомца - ожидаем ошибку
        RestAssured.given()
                .contentType(ContentType.JSON)
                .body(myPet).delete("https://petstore.swagger.io/v2/pet/" + myPet.getId()).then().statusCode(404);
